...
If you do have problems with your Excel files please have a look at the [FAQ](https://wordpress.org/plugins/gravity-forms-to-excel-addon/faq/).
...
4. Using simple formulas (e.g. A1=...) your Excel sheet will show the data coming from the web form.
